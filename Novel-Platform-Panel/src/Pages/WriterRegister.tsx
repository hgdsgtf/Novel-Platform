...
import { WriterRegisterMessage } from 'Plugins/WriterAPI/WriterRegisterMessage'
...
const WriterRegister = () => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await axios.post(
                new WriterRegisterMessage(name, email, password, verificationCode).getURL(),
                JSON.stringify(new WriterRegisterMessage(name, email, password, verificationCode)),
                {
                    headers: { 'Content-Type': 'application/json' },
                }
            )
