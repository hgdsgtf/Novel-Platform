...
import { AuditorLoginMessage } from 'Plugins/AuditorAPI/AuditorLoginMessage';
...
const AuditorLogin: React.FC = () => {
    ...
    const handleLogin = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            await axios.post(
                new AuditorLoginMessage(username, password).getURL(),
                JSON.stringify(new AuditorLoginMessage(username, password)),
                {
        ...
        <div className={styles.box} id="clickEffectContainer">
            ...
            <div className={styles.right}>
                ...
                <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <button
                        onClick={() => history.push('/auditorforgotpassword')}
